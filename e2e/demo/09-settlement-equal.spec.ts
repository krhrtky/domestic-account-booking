...
test.describe.skip("Scenario 9: Settlement Calculation - Equal Ratio", () => {
  ...
  test("should calculate settlement with 50/50 ratio correctly", async ({
    page,
  }) => {
    ...
    await expect(
      page.getByText(/ユーザーBがSettlement Userに.*を支払う/),
